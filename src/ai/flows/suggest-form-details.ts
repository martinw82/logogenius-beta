...
const SuggestFormDetailsOutputSchema = z.object({
...
Available Preferred Logo Styles: ${availableLogoStyles}
Available Brand Archetypes: ${availableBrandArchetypes}
...
8.  Preferred Logo Style (Choose ONE from the "Available Preferred Logo Styles" list provided above. Ensure it is an exact match from the list.):
...
11. Brand Archetype (Choose ONE from the "Available Brand Archetypes" list provided above. Ensure it is an exact match from the list.):
